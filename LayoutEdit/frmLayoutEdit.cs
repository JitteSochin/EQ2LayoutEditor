...
{
    public partial class frmLayoutEdit : Form
    {
        ...
        private void layoutLibraryToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmLibrary fl = new frmLibrary();
            fl.Show();
        }
    }
}
